use master;
create database [Microservices.applicants];
GO
use [Microservices.applicants];
...
create database [Microservices.jobs];
GO
use [Microservices.jobs];
